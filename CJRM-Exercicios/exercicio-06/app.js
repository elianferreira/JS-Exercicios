...
const age = 21;
let entrada_gratis = 'Para você, a entrada é grátis!';
let entrada_paga = 'A entrada é R$ 30,00.';

if (age <= 7 || age >= 65) {
  console.log(entrada_gratis);
} else {
  console.log(entrada_paga);
}
...
console.log(
  `Números impares: ${oddNumbers.join(', ')}.`.replace('10,', '10 e ') +
    ` Números pares: ${pairNumbers.join(', ')}`.replace('67,', '67 e ')
);
