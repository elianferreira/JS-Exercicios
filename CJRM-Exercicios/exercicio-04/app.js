...
const my3FavoriteTVShows = ['Supernatural', 'GOT', 'Dark'];
...
/*
  ...
  caracteres? BOOLEAN."
*/
const numberCaracteres = 39;

// console.log(`A string que a "typeSentence" armazena tem mais de ${numberCaracteres}
// caracteres? ${typeSentence.length > numberCaracteres}.`);
...
// Null é um tipo atribuido pelo usuário, é um valor nulo se eu somar com + 1 volta 1.
// é como se eu fosse somar nada com 1. Vai voltar 1.
